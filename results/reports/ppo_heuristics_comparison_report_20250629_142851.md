...
**Erstellt am:** 2025-06-29 14:28:51
...
- **PPO Agent Durchschnittsrang:** 6.2 von 8 Methoden
...
|---------|----------------|------------|-------------------|-----------------------|
| PPO Agent | 6858.3 | 0.984 | 0.0 | 4040.9 |
...
### Ranking pro Metrik:
- **Makespan:** Platz 9/8 (6858.3 Min)
- **Maschinenauslastung:** Platz 6/8 (0.984)
- **Deadline-Erfüllung:** Platz 1/8 (0.0%)
- **Verspätung:** Platz 9/8 (4040.9 Min)
...
#### PPO vs. SPT:
- **Makespan:** -1.3% ❌ Schlechter
- **Auslastung:** +1.9% ✅ Besser
- **Verspätung:** -2.2% ❌ Schlechter
...
- **Gute Maschinenauslastung:** Platz 6/8, effiziente Ressourcennutzung
...
Der PPO Agent zeigt **durchschnittliche Performance** mit einem Gesamtrang von 6.2/8. Während er in der Maschinenauslastung gut abschneidet (Platz 6), gibt es deutliches Verbesserungspotential bei der Makespan-Optimierung (Platz 9) und Verspätungsminimierung (Platz 9).
...
*Report generiert am 2025-06-29 14:28:51*
